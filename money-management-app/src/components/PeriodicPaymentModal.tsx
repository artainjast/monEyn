                    ...
                    <div className="flex items-center">
                        ...
                        <div>
                            ...
                            <p className="text-blue-700">
                                ...
                                {editingLoan && ` Total to pay back: ${editingLoan.totalPayback.toLocaleString()} ${editingLoan.currency}`}
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm">
                            <div>
                                ...
                                <p className="font-semibold">{editingLoan.principalAmount.toLocaleString()} {editingLoan.currency}</p>
                            </div>
                            <div>
                                <span className="text-gray-500">Total Payback:</span>
                                <p className="font-semibold">{editingLoan.totalPayback.toLocaleString()} {editingLoan.currency}</p>
                            </div>
                            <div>
                                <span className="text-gray-500">Interest Amount:</span>
                                <p className="font-semibold">{(editingLoan.totalPayback - editingLoan.principalAmount).toLocaleString()} {editingLoan.currency}</p>
                            </div>
                            <div>
                            ...
                            <div className="space-y-2">
                                <div className="flex justify-between text-sm">
                                    ...
                                    <span className="font-semibold">
                                        {(editingLoan.totalPayback / periodicConfig.numberOfMonths).toLocaleString()} {editingLoan.currency}
                                    </span>
                                </div>
                                <div className="flex justify-between text-sm">
