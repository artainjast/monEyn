            ...
            <div className="space-y-3">
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <p className="font-semibold text-gray-900">
                            {loan.principalAmount.toLocaleString()} {loan.currency}
                        </p>
                    </div>
                    <div>
                        <p className="text-sm text-gray-500">Total Payback</p>
                        <p className="font-semibold text-gray-900">
                            {loan.totalPayback.toLocaleString()} {loan.currency}
                        </p>
                    </div>
                </div>
                ...
                {loan.wageFee > 0 && (
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <p className="font-semibold text-gray-900">
                                {loan.wageFee.toLocaleString()} {loan.currency}
                            </p>
                        </div>
                        <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <p className="font-semibold text-gray-900">
                            {summary.remainingBalance.toLocaleString()} {loan.currency}
                        </p>
                    </div>
                    <div>
                                ...
                                <div key={payment.id} className="flex justify-between items-center text-sm">
                                    ...
                                    <div className="flex items-center space-x-2">
                                        <span className={`font-medium ${payment.status === 'paid' ? 'text-green-600' :
                                            ...
                                            {payment.amount.toLocaleString()} {loan.currency}
                                        </span>
