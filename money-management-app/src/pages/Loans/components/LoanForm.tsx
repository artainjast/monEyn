                                ...
                                <div className="space-y-2">
                                    <div className="flex justify-between text-sm">
                                        ...
                                        <span className="font-semibold">
                                            {(parseFloat(formData.totalPayback || '0') / periodicConfig.numberOfMonths).toLocaleString('fa-IR')} {formData.currency}
                                        </span>
                                    </div>
                                    <div className="flex justify-between text-sm">
                            ...
                            <div className="bg-gray-50 rounded-lg p-3">
                                ...
                                <div className="mt-2 pt-2 border-t border-gray-200">
                                    ...
                                    <div className="flex justify-between text-sm">
                                        ...
                                        <span className="font-semibold">
                                            {parseFloat(formData.totalPayback || '0').toLocaleString('fa-IR')} {formData.currency}
                                        </span>
                                    </div>
                        ...
                        <div className="flex items-center">
                            ...
                            <div>
                                ...
                                <p className="text-blue-700">
                                    Click on dates to set when payments should be made. {editingLoan ? `Total payback amount: ${editingLoan.totalPayback.toLocaleString('fa-IR')} ${editingLoan.currency}` : `Total payback amount: ${formData.totalPayback ? parseFloat(formData.totalPayback).toLocaleString('fa-IR') : '0'} ${formData.currency}`}
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="border-t border-green-200 pt-2 mt-2">
                                    <div className="flex justify-between font-semibold text-green-800">
                                        ...
                                        <span>
                                            {paymentSchedule.reduce((sum, payment) => sum + payment.amount, 0).toLocaleString('fa-IR')} {editingLoan ? editingLoan.currency : formData.currency}
                                        </span>
                                    </div>
                                    <div className="flex justify-between text-sm mt-1">
                                        <span>Total Payback:</span>
                                        <span>
                                            {(editingLoan ? editingLoan.totalPayback : parseFloat(formData.totalPayback || '0')).toLocaleString('fa-IR')} {editingLoan ? editingLoan.currency : formData.currency}
                                        </span>
                                    </div>
                                    {paymentSchedule.length > 0 && (
                                        <div className={`text-sm font-medium mt-2 ${Math.abs(paymentSchedule.reduce((sum, payment) => sum + payment.amount, 0) - (editingLoan ? editingLoan.totalPayback : parseFloat(formData.totalPayback || '0'))) < 0.01
                                            ...
                                            {Math.abs(paymentSchedule.reduce((sum, payment) => sum + payment.amount, 0) - (editingLoan ? editingLoan.totalPayback : parseFloat(formData.totalPayback || '0'))) < 0.01
                                                ...
                                                : `❌ Payment total must equal total payback amount (difference: ${Math.abs(paymentSchedule.reduce((sum, payment) => sum + payment.amount, 0) - (editingLoan ? editingLoan.totalPayback : parseFloat(formData.totalPayback || '0'))).toLocaleString('fa-IR')} ${editingLoan ? editingLoan.currency : formData.currency})`
                                            }
                                        </div>
                                    )}
                                </div>
                        ...
                        <Button
                            onClick={() => {
                                if (onSetPaymentSchedule) {
                                    onSetPaymentSchedule(paymentSchedule);
                                }
                                setShowPaymentScheduleModal(false);
                                setSelectedDate(null);
                                setPaymentAmount('');
